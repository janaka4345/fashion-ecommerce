...
export default function PriceCard() {
  return (
    <Card className=" w-[16svw] min-w-[14svw] max-w-[18svw] rounded-lg border border-gray-200 bg-white shadow dark:border-gray-700 dark:bg-gray-800">
      ...
      <CardContent className="mx-auto p-0 px-5 pt-3">
        <Link href="#">
        ...
        <div className="mb-5 mt-2.5 flex items-center">
          <div className="flex items-center space-x-1 rtl:space-x-reverse">
            ...
            <Icon name={"star"} className="h-5 w-5 fill-yellow-300" />
            <Icon name={"star"} className="h-5 w-5   fill-yellow-300" />
            <Icon name={"star"} className="h-5 w-5   fill-yellow-300" />
            <Icon name={"star"} className="h-5 w-5   fill-yellow-300" />
            <Icon name={"star"} className="ck h-5  w-5 fill-gray-400" />
            {/* <svg
              className="h-4 w-4 text-yellow-300"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
